...
// 1.
var greeting = function(hello, location, time) {
    return hello + ", we're from  " + location + "and arrived at " + time;
  }
...
// 7.
var votes = dogs.reduce(function(accumulator, result) {
    return accumulator + result.votes;
}, 0);